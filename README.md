# Build Report Markdown Generator
...
Generates markdown for a build report, containing for example JUnit report, code coverage report, etc. An example result can be found [here](./result.md).
